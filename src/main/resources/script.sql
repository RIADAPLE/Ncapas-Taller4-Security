...
INSERT INTO `users` (`username`, `password`, `enabled`) VALUES ('wsalazar', 'salazar', '1');
INSERT INTO `users_roles` (`user_id`, `role_id`) VALUES (1, 4); -- user patrick has role ADMIN
...
INSERT INTO `users_roles` (`user_id`, `role_id`) VALUES (6, 4); -- user admin has role ADMIN

INSERT INTO `users_roles` (`user_id`, `role_id`) VALUES (2, 5); -- user alex has role TECNICO
INSERT INTO `users_roles` (`user_id`, `role_id`) VALUES (3, 5); -- user john has role TECNICO
INSERT INTO `users_roles` (`user_id`, `role_id`) VALUES (4, 5); -- user namhm has role TECNICO
